...
interface DataTableFacetedFilterProps {
    ...
    options: {
        ...
        value: string
        iconMap?: React.ComponentType<{ className?: string }> | any
    }[]
    disabled?: boolean
    multiSelect?: boolean
            ...
            <PopoverTrigger asChild>
                ...
                >
                    ...
                    {selectedValueSet.size > 0 && (
                        <>
                            <Separator className="mx-0 h-4" orientation="vertical" />
                            <Badge variant="secondary"
                                className="rounded-sm px-1 font-normal lg:hidden">{selectedValueSet.size}
                            </Badge>
                                ...
                                options.map((option) => {
                                    ...
                                    return (
                                        <CommandItem
                                            ...
                                            {option.iconMap && (
                                                <option.iconMap className="mr-2 h-4 w-4 text-muted-foreground" />
                                            )}
